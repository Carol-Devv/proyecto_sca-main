...
customElements.define('compodoc-menu', class extends HTMLElement {
    ...
    render(isNormalMode) {
        ...
        <nav>
            <ul class="list">
                <li class="title">
                    <a href="index.html" data-type="index-link">proyecto-sca documentation</a>
                </li>
                ...
                <li class="chapter">
                    ...
                    <li class="chapter">
                        ...
                        <ul class="links collapse " ${ isNormalMode ? 'id="components-links"' : 'id="xs-components-links"' }>
                            ...
                            <li class="link">
                                <a href="components/China.html" data-type="entity-link" >China</a>
                            </li>
                            <li class="link">
                                <a href="components/Comenzar.html" data-type="entity-link" >Comenzar</a>
                            </li>
                            <li class="link">
                                <a href="components/Comidas.html" data-type="entity-link" >Comidas</a>
                            </li>
                            <li class="link">
                                <a href="components/Confirmacion.html" data-type="entity-link" >Confirmacion</a>
                            </li>
                            <li class="link">
                                <a href="components/Espanola.html" data-type="entity-link" >Espanola</a>
                            </li>
                            <li class="link">
                                <a href="components/Estilos.html" data-type="entity-link" >Estilos</a>
                            </li>
                            <li class="link">
                                <a href="components/Fallida.html" data-type="entity-link" >Fallida</a>
                            </li>
                            <li class="link">
                                <a href="components/HacerPedido.html" data-type="entity-link" >HacerPedido</a>
                            </li>
                            <li class="link">
                                <a href="components/India.html" data-type="entity-link" >India</a>
                            </li>
                            <li class="link">
                                <a href="components/Italiana.html" data-type="entity-link" >Italiana</a>
                            </li>
                            <li class="link">
                                <a href="components/Japonesa.html" data-type="entity-link" >Japonesa</a>
                            </li>
                            <li class="link">
                                <a href="components/Landing.html" data-type="entity-link" >Landing</a>
                            </li>
                            <li class="link">
                                <a href="components/Magrebi.html" data-type="entity-link" >Magrebi</a>
                            </li>
                            <li class="link">
                                <a href="components/Menu.html" data-type="entity-link" >Menu</a>
                            </li>
                            <li class="link">
                                <a href="components/Mexicana.html" data-type="entity-link" >Mexicana</a>
                            </li>
                            <li class="link">
                                <a href="components/Perfil.html" data-type="entity-link" >Perfil</a>
                            </li>
                            <li class="link">
                                <a href="components/Rapida.html" data-type="entity-link" >Rapida</a>
                            </li>
                        </ul>
                    </li>
                        <li class="chapter">
                            ...
                            <ul class="links collapse " ${ isNormalMode ? 'id="injectables-links"' : 'id="xs-injectables-links"' }>
                                <li class="link">
                                    <a href="injectables/DataTransferService.html" data-type="entity-link" >DataTransferService</a>
                                </li>
                                <li class="link">
                                    <a href="injectables/HbsRenderService.html" data-type="entity-link" >HbsRenderService</a>
                                </li>
                                <li class="link">
                                    <a href="injectables/OrderDBService.html" data-type="entity-link" >OrderDBService</a>
                                </li>
                                <li class="link">
                    ...
                    <li class="chapter">
                        ...
                        <ul class="links collapse " ${ isNormalMode ? ' id="interfaces-links"' : 'id="xs-interfaces-links"' }>
                            <li class="link">
                                <a href="interfaces/Comida.html" data-type="entity-link" >Comida</a>
                            </li>
                            <li class="link">
                                <a href="interfaces/CompoDocConfig.html" data-type="entity-link" >CompoDocConfig</a>
                            </li>
                            <li class="link">
                                <a href="interfaces/ConfirmarResponse.html" data-type="entity-link" >ConfirmarResponse</a>
                            </li>
                            <li class="link">
                                <a href="interfaces/FallidoResponse.html" data-type="entity-link" >FallidoResponse</a>
                            </li>
                            <li class="link">
